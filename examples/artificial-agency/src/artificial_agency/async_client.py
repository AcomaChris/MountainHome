...
class AsyncClient:
    ...
    async def _process_request(
        ...
        *,
        ...
        request = self._build_request(method=method, path=path, data=data)
    ...
    async def list_services(self) -> list[api_types.Service]:
        """List the services defined for your organization."""
